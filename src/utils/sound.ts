...
class RetroMusicLoop {
  ...
  private readonly melody = [523.25, 659.25, 783.99, 659.25, 587.33, 698.46, 783.99, 698.46];
  private readonly bass = [130.81, 130.81, 146.83, 146.83, 174.61, 174.61, 146.83, 146.83];
